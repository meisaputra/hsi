							...
							<div style="padding-left:20px;padding-right:20px;">
								<div class="row">
									<div class="col-sm-3">
										...
										<li><a href="<?php echo base_url('input/inputFormMou014'); ?>">Form 014.MOU</a></li>
									</div>
									<div class="col-sm-3">
										<h3 style="font-size: 18px;font-weight:bold;">Jiggering</h3>
										<li><a href="<?php echo base_url('input/inputFormJig004'); ?>">Form 004.JIG</a></li>
										<li><a href="<?php echo base_url('input/inputFormJig002'); ?>">Form 002.JIG</a></li>
									</div>
									<div class="col-sm-3">
