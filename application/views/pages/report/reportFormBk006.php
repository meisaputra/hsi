<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="well">
                <h2>Laporang Harian Keluar Harian BK</h2>
                <p><strong>About: </strong> Report Form 006.BK</p>
                <p><strong>Departement: </strong> BK</p>
            </div>      
        </div>
        <div class="col-md-6">
            <div class="alert alert-info" role="alert">Original Form : NO.006.F.BK.PROD.REVISI-0</div>
        </div>
    </div>
