<div class="container">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="well">
                <h2>Laporan Kerusakan Banding</h2>
                <p><strong>About: </strong> Report Form 001.GLZ</p>
            </div>      
		</div>
		<div class="col-md-6">
			<div class="alert alert-info" role="alert">Original Form : NO.001.F.GLZ.PROD.REVISI-0</div>
		</div>
	</div>
	<hr>
    ...
    <script type="text/javascript">
	    $(document).ready(function () {
	        ...
	        $("#jqxgrid_product").jqxGrid(
	        {
	            ...
	            columnsresize: true,
	            columns: [
	              { text: 'Item', datafield: 'item', cellsalign: 'left', cellsrenderer: cellsrenderer, width: '20%' },
	              ...
	              { text: 'Band', datafield: 'band', cellsalign: 'right', cellsrenderer: cellsrenderer, width: '10%' },
