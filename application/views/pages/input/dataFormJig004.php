<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo base_url('input/dataFormJig004'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-sm-12">
                    <a class="btn btn-sm btn-success" href="<?php echo base_url("input/inputFormJig004"); ?>">Tambah data</a>
                </div>
            </div>
            <hr>
            <div class="row">
...
if ( isset( $post ) ) {
    ...
    if ( !empty( $post ) ) {
        ...
        $url_load_data = "load/loadDataFormJig004?period=". $post['period']
        ...
        $url_load_data = "load/loadDataFormJig004?period=default_range&default_range_value=today";
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var button_renderer = function (row, columnfield, value, defaulthtml, columnproperties) {
            ...
            var button = '<a class="btn btn-xs btn-primary" href="'+ '<?php echo base_url('input/editFormJig004'); ?>' +'?master_id='+ master_id +'">Ubah</a>'+ 
                            '<a class="btn btn-xs btn-danger" href="'+ '<?php echo base_url('action/deleteFormJig004'); ?>' +'?master_id='+ master_id +'">Hapus</a>';
            return button;
