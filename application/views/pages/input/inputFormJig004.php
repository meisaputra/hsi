<div class="container">
    <div class="row">
        <div class="col-sm-12">
    		<legend>Form : 004.JIG</legend>
    	</div>
    </div>
    <div class="row">
    	<div class="col-sm-6">
			<a href="<?php echo base_url("input/dataFormJig004"); ?>" class="btn btn-sm btn-success">Kembali</a>
			...
			?>
    		<form action="<?php echo base_url('action/insertFormJig004'); ?>" method="post">
	    		<div class="panel panel-default">
	    			<div class="panel-heading">
	    				<h3 class="panel-title"><strong>Pengecekan</strong></h3>
	    			</div>
