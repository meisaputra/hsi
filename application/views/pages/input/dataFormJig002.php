<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="well">
                <h2>002.JIG</h2>
                <p><strong>Tentang: </strong> list</p>
            </div>      
        </div>
        <div class="col-md-6">
            <div class="alert alert-info" role="alert">Nomor Form : </div>
        </div>
    </div>
    <hr>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo base_url('input/dataFormJig002'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-sm-12">
                    <a class="btn btn-sm btn-success" href="<?php echo base_url("input/inputFormJig002"); ?>">Tambah data</a>
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <?php if ( !empty( $post ) ) : ?>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    if ( $post['period'] == 'default_range' ) {
                                        ...
                                        echo "Menampilkan data dari <b>". $post['default_range_value'] ."</b>";

                                    } else {

                                        echo "Menampilkan data dari <b>". $post['custom_range_start_value'] ."</b> to <b>". $post['custom_range_end_value'] ."</b>";
                            ...
                            <button class="btn btn-sm btn-success" type="button" id='excelExport'>Ekspor ke excel</button>
...
if ( isset( $post ) ) {
    ...
    if ( !empty( $post ) ) {
        ...
        $url_load_data = "load/loadDataFormJig002?period=". $post['period']
        ...
        $url_load_data = "load/loadDataFormJig002?period=default_range&default_range_value=today";
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var button_renderer = function (row, columnfield, value, defaulthtml, columnproperties) {
            ...
            var button = '<a class="btn btn-xs btn-primary" href="'+ '<?php echo base_url('input/editFormJig002'); ?>' +'?master_id='+ master_id +'">Edit</a>'+ 
                            '<a class="btn btn-xs btn-danger" href="'+ '<?php echo base_url('action/deleteFormJig002'); ?>' +'?master_id='+ master_id +'">Delete</a>';
            return button;
        ...
        $("#jqxgrid_product").jqxGrid(
        {
            ...
            columns: [
                ...
                { text: 'Tanggal', datafield: 'inspect_date', cellsalign: 'left', width: 100 },
                { text: 'Jam', datafield: 'inspect_time', cellsalign: 'left', width: 100 },
                { text: 'Item', datafield: 'item_code', cellsalign: 'left', width: 100 },
                { text: 'Mesin', datafield: 'machine_id', cellsalign: 'left', width: 100 },
